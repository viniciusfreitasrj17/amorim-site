      ...
      <div className='row'>
        <div className="col-md-6 row">
          <div className="col-md-6 col-4">
            <h3 className='footer-group-title' >Início</h3>
            <a className='footer-link-a' onClick={() => hashHistory.push('/')} ><MdKeyboardArrowRight size={25} /> Home</a>
          </div>
          <div className="col-md-6 col-8">
            <h3 className='footer-group-title' style={{textAlign: 'center'}}>Serviços</h3>
        ...
        <div className="col-md-6 footer-group-redes">
          <h3 className='footer-group-title' >Siga-nos em nossas Redes Sociais</h3>
