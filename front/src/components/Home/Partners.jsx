...
const Partners = ({ heightOnPage }) => {
  ...
  useEffect(() => {
    ...
    const $part = document.querySelectorAll('.partners-container')[0]
  ...
  return (
    <section className='container partners-container notAnim' id='partners'>
